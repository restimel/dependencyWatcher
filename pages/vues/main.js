...
Vue.component('dependency-watcher', {
    ...
    methods: {
        getItems: function(value) {
            ...
            this.items = new Map();
            configuration.perfStart('getItems');
            ...
            fetch(url)
                ...
                .then(response => {
                    configuration.perfEnd('getItems');
                    configuration.perfStart('displayItems');
        ...
        loadWorkspace: function(name) {
            var ws = configuration.workspaces.find((ws) => ws.name === name);
    ...
    updated: function() {
        configuration.perfEnd('displayItems');
    },
    template: `
<div>
    <aside
